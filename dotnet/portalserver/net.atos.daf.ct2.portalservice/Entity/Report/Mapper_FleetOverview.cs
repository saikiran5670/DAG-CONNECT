        ...
        public List<VehicleHealthStatus> ToVehicleHealthStatus(reportservice.VehicleHealthStatusListResponse vhsList)
        {
            ...
            foreach (var item in vhsList.HealthStatus)
            {
                var vhs = new VehicleHealthStatus()
                {
                    ...
                    LatestGeolocationAddressId = item.LctsLatestGeolocationAddressId,
                    ...
                    StartGeolocationAddressId = item.LctsStartGeolocationAddressId,
                    ...
                    LatestWarningGeolocationAddressId = item.LctsLatestWarningGeolocationAddressId,
                    Address = item.LctsAddress,
