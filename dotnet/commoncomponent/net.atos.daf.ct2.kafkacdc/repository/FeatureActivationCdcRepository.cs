...
{
    public class FeatureActivationCdcRepository : IFeatureActivationCdcRepository
    {
        private readonly IDataAccess _dataAccess;
        private readonly IDataMartDataAccess _dataMartdataAccess;

        public FeatureActivationCdcRepository(IDataAccess dataAccess, IDataMartDataAccess dataMartdataAccess)
        {
        ...
        public async Task<List<VehicleAlertRef>> GetVehiclesAndAlertFromSubscriptionConfiguration(int subscriptionId)
        {
            try
            {
                var parameter = new DynamicParameters();
