    ...
    public class VehicleRepository : IVehicleRepository
    {
        ...
        private Vehicle Map(dynamic record)
        {
            ...
            if (record.status_changed_date != null)
                vehicle.Status_Changed_Date = Convert.ToDateTime(UTCHandling.GetConvertedDateTimeFromUTC(record.status_changed_date,"Eastern Standard Time", "yyyy-MM-ddTHH:mm:ss"));
            if (record.termination_date != null)
                vehicle.Termination_Date = Convert.ToDateTime(UTCHandling.GetConvertedDateTimeFromUTC(record.termination_date, "Eastern Standard Time", "yyyy-MM-ddTHH:mm:ss"));
            ...
            if (record.reference_date != null)
                vehicle.Reference_Date = Convert.ToDateTime(UTCHandling.GetConvertedDateTimeFromUTC(record.reference_date, "Eastern Standard Time", "yyyy-MM-ddTHH:mm:ss"));
            return vehicle;
        }
