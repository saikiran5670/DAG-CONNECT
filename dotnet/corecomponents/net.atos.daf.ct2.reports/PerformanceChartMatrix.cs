...
namespace net.atos.daf.ct2.reports
{
    ...
    public class PerformanceChartMatrix
    {
        ...
        public VehiclePerformanceData GetcombinedmatrixRoadSpeed(List<VehPerformanceChartData> chartData, string performanceType, List<KpiDataRange> rangedata, double tripDuration)
        {
            //Console.WriteLine("Hello World!");
            VehiclePerformanceData result = new VehiclePerformanceData();
            List<ChartMatrix> matrix = new List<ChartMatrix>();
                            ...
                            foreach (var range in rangedata)
                            {
                                switch (range.Index)
                                {
                                    ...
                                    case 3:// "P":
                                        ...
                                        {
                                            range.Value += value;
                                            y = 7; // y changed as per charts color
