    ...
    public static class ReportTemplate
    {
        public const string REPORT_TEMPLATE = @"<html>
                                                ...
                                                <table style='width: 100%; border-collapse: collapse;' border = '0'>                   
                                                       <tr>
                                                            <td style = 'width: 25%;' > <strong>From:</strong>{2}</td>
                                                            <td style = 'width: 25%;'> <strong>To:</strong> {3}</td>
                                                            <td style = 'width: 25%;'> <strong>Vehicle:</strong> {4} </td>
                                                            <td style = 'width: 25%;' > <strong>Vehicle Name:</strong> {5}</td>
                                                            <td style = 'width: 25%;' > <strong>Registration #:</strong> {6}</td>                        
                                                      </tr>   
                                                 </table>
                                                    </br>{7}
                                                    </body>
