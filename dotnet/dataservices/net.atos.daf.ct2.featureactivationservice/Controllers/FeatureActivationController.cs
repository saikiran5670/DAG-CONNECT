            ...
            try
            {
                ...
                if (objsubscriptionActivation.SubscribeEvent != null)
                {
                    ...
                    else if (!string.IsNullOrEmpty(order.Item2.Response.OrderId) && order.Item2.Response.OrderId != "0")
                    {
                        ...
                        //await _featureActivationCdcHelper.TriggerSubscriptionCdc(subscriptionId, "I", Convert.ToInt32(objSubs.OrganizationId), objSubs.VINs);
                    }
                ...
                if (objsubscriptionActivation.UnsubscribeEvent != null)
                {
                    ...
                    else if (!string.IsNullOrEmpty(objUnsubs.OrderID) && objUnsubs.OrderID != "0")
                    {
                        ...
                        //await _featureActivationCdcHelper.TriggerSubscriptionCdc(subscriptionId, "U", Convert.ToInt32(objUnsubs.OrganizationID), objUnsubs.VINs);
                    }
