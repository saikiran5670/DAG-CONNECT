...
namespace net.atos.daf.ct2.roleservice.Controllers
{
    ...
    public class RoleManagementController : ControllerBase
    {
        ...
        private readonly IFeatureRepository feature;
        public RoleManagementController(IRoleManagement _roleManagement, IFeatureRepository _feature,ILogger<RoleManagementController> _logger)
        {
