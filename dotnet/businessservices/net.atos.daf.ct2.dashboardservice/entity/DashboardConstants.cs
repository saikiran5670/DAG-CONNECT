...
namespace net.atos.daf.ct2.dashboardservice.entity
{
    public static class DashboardConstants
    {
        ...
        public const string GET_ALERTLAST_24HOURS_SUCCESS_MSG = "Alert last 24hours fetched successfully.";
        public const string GET_ALERTLAST_24HOURS_FAILURE_MSG = "Alert last 24hours fetched failed. With Error : {0}";
    }
}
