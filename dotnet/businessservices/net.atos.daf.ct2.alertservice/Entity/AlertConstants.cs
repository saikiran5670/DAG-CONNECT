...
namespace net.atos.daf.ct2.alertservice.Entity
{
    ...
    {
        public const string ACTIVATED_ALERT_SUCCESS_MSG = "Alert is Activated successfully for Id:- {0}.";
        public const string ACTIVATED_ALERT_FAILURE_MSG = "Activate Alert failed for Id:- {0}.";
        public const string SUSPEND_ALERT_SUCCESS_MSG = "Alert is Suspended successfully for Id:- {0}.";
