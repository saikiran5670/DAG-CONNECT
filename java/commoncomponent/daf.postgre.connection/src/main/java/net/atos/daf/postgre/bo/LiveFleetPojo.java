...
public class LiveFleetPojo implements Serializable{
	...
	private Integer telltaleId;
	private Integer telltaleStateId;
	private Integer drivingTime;
	private Integer driver2AuthEquipmentTypeId;
	...
	public String toString() {
		return "LiveFleetPojo [tripId=" + tripId + ", vid=" + vid + ", vin=" + vin + ", messageTimestamp="
				...
				+ oem_driver_id + ", pto_id=" + ptoId + ", telltale_id=" + telltaleId + ", oem_telltale="
				+ oem_telltale + ", telltale_state_id=" + telltaleStateId + ", drivingTime=" + drivingTime
				...
				+ driver2_working_state + ", driver2_auth_equipment_type_id=" + driver2AuthEquipmentTypeId
