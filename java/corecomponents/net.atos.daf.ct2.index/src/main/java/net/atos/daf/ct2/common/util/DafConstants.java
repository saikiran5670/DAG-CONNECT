...
public static final String Index="I";
	...
	public static final String CREATE_TEMP_LATEST_WARNING_STATUS_AT_TRIP_START = "create temp table if not exists temp_latest_warning_status ( vehicle_health_status_type character(1)"
			+ ", warning_class integer,	warning_number integer, warning_type character(1), warning_time_stamp bigint, latitude double precision, longitude double precision"
			+ ", message_type integer, trip_id character varying(45), vin character varying(17) ) ";
	public static final String INSERT_INTO_TEMP_LATEST_WARNING_STATUS_AT_TRIP_START = 
	"insert into temp_latest_warning_status (vehicle_health_status_type, warning_class, warning_number, warning_type, warning_time_stamp, latitude, longitude, message_type"
	+ ", trip_id, vin) select distinct on (vin) vehicle_health_status_type, warning_class, warning_number, warning_type, warning_time_stamp, latitude, longitude, message_type"
	+ ", trip_id, vin from livefleet.livefleet_warning_statistics where vin = ? order by vin, warning_time_stamp desc ";
	public static final String READ_LATEST_ACTIVE_WARNING_STATUS_AT_TRIP_START = 
	"select vehicle_health_status_type, warning_class, warning_number, warning_type, warning_time_stamp, latitude, longitude, message_type, trip_id, vin "
	+ "from temp_latest_warning_status where vin = ? and warning_type = 'A'";
