...
public class MonitorWarningDataProcess {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			final StreamExecutionEnvironment env = envParams.get("flink.streaming.evn").equalsIgnoreCase("default") ?
					StreamExecutionEnvironment.getExecutionEnvironment() : FlinkUtil.createStreamExecutionEnvironment(envParams,envParams.get(DafConstants.WARNING_MONITOR_JOB)); 
			 ...
			 * consumerStream.addSink(new MonitorDataHbaseSink()); // Writing into HBase
			 * Table }
			 */
			...
			env.execute(envParams.get(DafConstants.MONITOR_WARNING_PROCESS));
