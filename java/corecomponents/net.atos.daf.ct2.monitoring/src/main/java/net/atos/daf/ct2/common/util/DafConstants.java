...
public class DafConstants {
	...
	public static final String MONITOR_JOB_rFMS = "MonitorJobrFMS";
	public static final String CHECKPOINT_DIRECTORY_MONITORING_rFMS = "checkpoint_directory_monitor_rFMS";
