...
public class PeriodKeyBasedAlertDefService extends KeyedBroadcastProcessFunction<Object, Tuple2<Index, Payload<Set<Long>>>, Payload<Object>, Index> implements Serializable {
    private static final Logger logger = LoggerFactory.getLogger(PeriodKeyBasedAlertDefService.class);
    private static final long serialVersionUID = 1L;
    private Map<Object, Object> configMap;

    public PeriodKeyBasedAlertDefService(Map<Object, Object> configMap){
