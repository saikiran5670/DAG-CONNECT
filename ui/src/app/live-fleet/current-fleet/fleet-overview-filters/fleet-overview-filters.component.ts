...
allSelectedHealthStatus = true;
allSelectedOther = true;
allSelectedAlertCategory = true;
allSelectedAlertLevel = true;
      ...
      this.detailsData.forEach(element => {
        ...
        if (currentDate > createdDate && currentDate < nextDate) {
          ...
          vehicleData.forEach(item =>
            this.groupList.push(item));
          //console.log("groupList2", this.groupList);
        }
        this.groupList = this.removeDuplicates(this.groupList, "vehicleGroupId");
...
removeDuplicates(originalArray, prop) {
  ...
  toggleAllSelectionHealth() {
    if(this.allSelectedHealthStatus) {
      ...
      if(this.filterVehicleForm.controls.otherFilter.value && this.filterVehicleForm.controls.otherFilter.value.length > 0){
  ...
  toggleAllSelectionOther(){
    if (this.allSelectedOther) {
      ...
      if(this.filterVehicleForm.controls.status.value && this.filterVehicleForm.controls.status.value.length > 0){
        this.onChangeHealthStatus();
      }else{
        this.vehicleListData = [];
        this.filterVINonMap();
  ...
  loadVehicleData(){
    ...
    this.getFleetOverviewDetails = this.reportService.getFleetOverviewDetails(this.objData).subscribe((fleetdata:any) => {
       fleetdata = [
        {
          "id": 67822,
          "tripId": "48ff64aa-f402-4fdb-ad91-7288b07b64a2",
          "vin": "XLR0998HGFFT74611",
          "startTimeStamp": 1640857889000,
          "endTimeStamp": 1640857915000,
          "driver1Id": "*",
          "tripDistance": 29792461,
          "drivingTime": 60,
          "fuelConsumption": 20,
          "vehicleDrivingStatusType": "S",
          "odometerVal": 242459920,
          "distanceUntilNextService": 0,
          "latestReceivedPositionLattitude": 51.43108368,
          "latestReceivedPositionLongitude": 5.514191151,
          "latestReceivedPositionHeading": 172.92438196308896,
          "startPositionLattitude": 255,
          "startPositionLongitude": 255,
          "startPositionHeading": 0,
          "latestProcessedMessageTimeStamp": 1640857915000,
          "vehicleHealthStatusType": "N",
          "latestWarningClass": 0,
          "latestWarningNumber": 0,
          "latestWarningType": " ",
          "latestWarningTimestamp": 0,
          "latestWarningPositionLatitude": 0,
          "latestWarningPositionLongitude": 0,
          "vid": "M4A14350",
          "registrationNo": "AV-AC1234",
          "driverName": "",
          "latestGeolocationAddressId": 4344,
          "latestGeolocationAddress": "5643 Eindhoven, Nederland",
          ...
          "liveFleetPosition": [
            {
              "gpsAltitude": 33,
              "gpsHeading": 172.92438196308896,
              "gpsLatitude": 51.43108368,
              "gpsLongitude": 5.514191151,
              "fuelconsumtion": 20,
              "co2Emission": 0.038,
              "id": 614483,
              "messageTimeStamp": 1640857915000
            },
            {
              "gpsAltitude": 13,
              "gpsHeading": 48.70459732380853,
              "gpsLatitude": 51.43090439,
              "gpsLongitude": 5.51406908,
              "fuelconsumtion": 4,
              "co2Emission": 0.0076,
              "id": 614481,
              "messageTimeStamp": 1640857893000
            },
            {
              "gpsAltitude": 255,
              "gpsHeading": 255,
              ...
              "co2Emission": 0,
              "id": 614479,
              "messageTimeStamp": 1640857889000
            }
          ],
          "fleetOverviewAlert": [],
          "vehicleName": "%K Veh new"
        },
        {
          "id": 66872,
          "tripId": "b00d7d7b-0d07-46d3-9980-c471536c4458",
          "vin": "XLRTEH4100G999999",
          "startTimeStamp": 1639164533000,
          "endTimeStamp": 1641186536000,
          "driver1Id": "PL B000379008000000",
          "tripDistance": 159237,
          "drivingTime": 1147,
          "fuelConsumption": 335,
          "vehicleDrivingStatusType": "U",
          "odometerVal": 387260,
          "distanceUntilNextService": 0,
          "latestReceivedPositionLattitude": 51.43409729,
          "latestReceivedPositionLongitude": 5.505261898,
          "latestReceivedPositionHeading": 121.327083280525,
          "startPositionLattitude": 51.43410492,
          "startPositionLongitude": 5.505251884,
          "startPositionHeading": 267.06017337479466,
          "latestProcessedMessageTimeStamp": 1639165698000,
          "vehicleHealthStatusType": "N",
          "latestWarningClass": 0,
          "latestWarningNumber": 0,
          "latestWarningType": " ",
          ...
          "latestWarningPositionLongitude": 0,
          "vid": "M4A522",
          "registrationNo": "asdfghjklmnbvcxzqwertyuiop1234567890!@#$%^&*()))))",
          "driverName": "PLB Peeters",
          "latestGeolocationAddressId": 3129,
          "latestGeolocationAddress": "Hugo van der Goeslaan 1A, 5643 TW Eindhoven, Nederland",
          "startGeolocationAddressId": 2100,
          "startGeolocationAddress": "Hugo van der Goeslaan 1A, 5643 TW Eindhoven, Nederland",
          "latestWarningGeolocationAddressId": 2100,
          "latestWarningGeolocationAddress": "Hugo van der Goeslaan 1A, 5643 TW Eindhoven, Nederland",
          "latestWarningName": "",
          "liveFleetPosition": [
            {
              "gpsAltitude": 32,
              "gpsHeading": 121.327083280525,
              "gpsLatitude": 51.43409729,
              "gpsLongitude": 5.505261898,
              "fuelconsumtion": 335,
              "co2Emission": 0.6365,
              "id": 586200,
              "messageTimeStamp": 1639165698000
            },
            {
              "gpsAltitude": 31,
              "gpsHeading": 329.75926349789563,
              "gpsLatitude": 51.43410492,
              "gpsLongitude": 5.505250931,
              "fuelconsumtion": 375,
              "co2Emission": 0.7125,
              "id": 586189,
              "messageTimeStamp": 1639165433000
            },
            {
              "gpsAltitude": 29,
              "gpsHeading": 2.289719544971624,
              "gpsLatitude": 51.43411255,
              "gpsLongitude": 5.505243778,
              "fuelconsumtion": 434,
              "co2Emission": 0.8246,
              "id": 586172,
              "messageTimeStamp": 1639165133000
            },
            {
              "gpsAltitude": 27,
              "gpsHeading": 243.4326081766521,
              "gpsLatitude": 51.43410492,
              "gpsLongitude": 5.505247116,
              "fuelconsumtion": 515,
              "co2Emission": 0.9785,
              "id": 586153,
              "messageTimeStamp": 1639164833000
            },
            {
              "gpsAltitude": 24,
              "gpsHeading": 267.06017337479466,
              "gpsLatitude": 51.43410492,
              "gpsLongitude": 5.505251884,
              "fuelconsumtion": 0,
              "co2Emission": 0,
              "id": 586150,
              "messageTimeStamp": 1639164533000
            },
            {
              "gpsAltitude": 24,
              "gpsHeading": 267.06017337479466,
          ...
          "vehicleName": "0G999999"
        },
        {
          "id": 63268,
          "tripId": "8cd6a651-eb0c-4c99-a819-0328f582623e",
          "vin": "XLRTEH4300G224957",
          "startTimeStamp": 1637750070000,
          "endTimeStamp": 1637750251000,
          "driver1Id": "NL B000379008000000",
          "tripDistance": 2244367,
          "drivingTime": 144,
          "fuelConsumption": 138,
          "vehicleDrivingStatusType": "S",
          "odometerVal": 11899070,
          "distanceUntilNextService": 0,
          "latestReceivedPositionLattitude": 51.12992096,
          "latestReceivedPositionLongitude": 4.92984581,
          "latestReceivedPositionHeading": 173.5914,
          "startPositionLattitude": 51.43388367,
          "startPositionLongitude": 5.507391453,
          "startPositionHeading": 232.74995002775717,
          "latestProcessedMessageTimeStamp": 1638072689000,
          "vehicleHealthStatusType": "N",
          "latestWarningClass": 9,
          "latestWarningNumber": 41,
          "latestWarningType": "A",
          "latestWarningTimestamp": 1638072689000,
          "latestWarningPositionLatitude": 51.12992096,
          "latestWarningPositionLongitude": 4.92984581,
          "vid": "4A15445",
          "registrationNo": "AB-99-CD",
          "driverName": "Olaf Noordegraaf",
          "latestGeolocationAddressId": 3467,
          "latestGeolocationAddress": "Van Doornelaan, 2260 Westerlo, België",
          "startGeolocationAddressId": 4665,
          "startGeolocationAddress": "DAF, 5643 Eindhoven, Nederland",
          "latestWarningGeolocationAddressId": 4665,
          "latestWarningGeolocationAddress": "DAF, 5643 Eindhoven, Nederland",
          "latestWarningName": "",
          "liveFleetPosition": [
            {
              "gpsAltitude": 17,
              "gpsHeading": 351.2756147048928,
              "gpsLatitude": 51.43386078,
              "gpsLongitude": 5.507742882,
              "fuelconsumtion": 138,
              "co2Emission": 0,
              "id": 526331,
              "messageTimeStamp": 1637750251000
            },
            {
              "gpsAltitude": 18,
              "gpsHeading": 232.74995002775717,
              "gpsLatitude": 51.43388367,
              "gpsLongitude": 5.507391453,
              "fuelconsumtion": 0,
              "co2Emission": 0,
              "id": 526326,
              "messageTimeStamp": 1637750070000
            },
            {
              "gpsAltitude": 17,
              "gpsHeading": 351.2756147048928,
        ...
        },
        {
          ...
          "odometerVal": 0,
          "distanceUntilNextService": 0,
          "latestReceivedPositionLattitude": 0,
          "latestReceivedPositionLongitude": 0,
          "latestReceivedPositionHeading": 0,
          "startPositionLattitude": 0,
          "startPositionLongitude": 0,
          "startPositionHeading": 0,
          "latestProcessedMessageTimeStamp": 0,
          "vehicleHealthStatusType": "N",
          "latestWarningClass": 0,
          "latestWarningNumber": 0,
          "latestWarningType": "",
          ...
          "latestWarningPositionLongitude": 0,
          "vid": "",
          "registrationNo": "AB-99",
          "driverName": "Unknown",
          "latestGeolocationAddressId": 0,
          "latestGeolocationAddress": "",
          "startGeolocationAddressId": 0,
          "startGeolocationAddress": "",
          "latestWarningGeolocationAddressId": 0,
          "latestWarningGeolocationAddress": "",
          ...
          "liveFleetPosition": [],
          "fleetOverviewAlert": [],
          "vehicleName": "test_vehicle retest 13474 testing testing12"
        }
      ]
      let data = this.fleetMapService.processedLiveFLeetData(fleetdata);
    this.fleetData = data;
