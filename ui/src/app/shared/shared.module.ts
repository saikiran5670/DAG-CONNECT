...
@NgModule({
  declarations: [CommonFilterComponent, RemoveDuplicatesPipe, CustomPaginationComponent, SpinnerComponent, ActiveInactiveDailogComponent, TermsConditionsPopupComponent],
  imports: [
    CommonModule,
    FlexLayoutModule,
