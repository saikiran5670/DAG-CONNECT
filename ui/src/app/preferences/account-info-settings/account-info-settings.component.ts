...
export class AccountInfoSettingsComponent implements OnInit {
  ...
  loadGeneralSettingData(_accountInfo: any){
    ...
    this.accountNavMenu.forEach(element => {
    ...
    if(languageCode.toUpperCase() == 'EN-GB'){
      this.callToProceed(preferenceId, this.accountNavMenu, _prefData, _accountInfo);
    }else{
      if(_prefData && _prefData.isUpdate){
        ...
        this.translationService.getPreferences(languageCode).subscribe((_data: any) => { 
          if(_data){
            ...
            this.callToProceed(preferenceId, this.accountNavMenu, _data, _accountInfo); 
          }
        }, (error) => {  });
      }
    }
  ...
  callToProceed(preferenceId: any, accountNavMenu: any, data: any, _accountInfo: any){
      ...
      this.landingPageDisplayDropdownData = accountNavMenu.slice(0);
      ...
      if(preferenceId > 0){ //-- account pref
        ...
        this.organizationService.getOrganizationPreference(this.organizationId).subscribe((data: any) => {
          this.orgDefaultPreference = {
            ...
            pageRefreshTime : data.pageRefreshTime ? data.pageRefreshTime : 1,
            landingPageDisplayId: (this.accountNavMenu.length > 0) ? this.accountNavMenu[0].id : 0 // this.landingPageDisplayDropdownData[0].id //-- set default landing page for org 
          };
          this.pageRefreshTimeData = this.orgDefaultPreference.pageRefreshTime;
          this.updateBrandIcon();
  ...
  updateBrandIcon(){
    ...
    this.uploadLogo = (this.accountPreferenceData && this.accountPreferenceData["iconByte"] && this.accountPreferenceData["iconByte"] != "") ?  this.domSanitizer.bypassSecurityTrustUrl('data:image/jpg;base64,' + this.accountPreferenceData["iconByte"]) : this.domSanitizer.bypassSecurityTrustUrl('data:image/jpg;base64,' + defaultIcon);
    if(this.accountPreferenceData && this.accountPreferenceData["iconByte"] && this.accountPreferenceData["iconByte"] == "")
  ...
  setDefaultGeneralSetting(){
    setTimeout(()=>{
      ...
      this.userSettingsForm.get('landingPage').setValue(this.landingPageDisplayData.length > 0 ? this.landingPageDisplayData[0].id : this.accountNavMenu.length > 0 ? this.accountNavMenu[0].id : 0); //this.landingPageDisplayDropdownData[0].id);
  ...
  onGeneralSettingsUpdate(){
    if(this.brandLogoError == ''){
      if(!this.brandLogoFileValidated){
        let defaultIcon = ``;
        this.uploadLogo = (this.accountPreferenceData && this.accountPreferenceData?.["iconByte"] != "" && this.uploadLogo != '') ? this.domSanitizer.bypassSecurityTrustUrl('data:image/jpg;base64,' + this.accountPreferenceData?.["iconByte"]) : this.domSanitizer.bypassSecurityTrustUrl('data:image/jpg;base64,' + defaultIcon);
      }
      ...
      let objData: any = {
        ...
        landingPageDisplayId: this.userSettingsForm.controls.landingPage.value ? this.userSettingsForm.controls.landingPage.value : this.accountNavMenu.length > 0 ? this.accountNavMenu[0].id : 0, //this.landingPageDisplayDropdownData[0].id,
