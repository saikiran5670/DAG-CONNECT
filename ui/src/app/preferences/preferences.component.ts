...
export class PreferencesComponent implements OnInit {
  ...
  ngOnInit() {
    let langCode = 'EN-GB';
    let labelList = 'lblAccountInformation,lblSalutation,lblFirstName,lblLastName,lblLoginEmail,lblOrganization,lblLanguage,lblTimeZone,lblUnit,lblCurrency,lblDateFormat,lblTimeFormat,lblVehicleDisplayDefault,lblLandingPageDisplayDefault,lblAllDetailsAreMandatory,lblCancel,lblConfirm,lblReset,lblSearch,lblUpdate,lblPreferences,lblPersonaliseyourowndisplaysettings,lblAccountInfoSettings,lblGeneralSettings,lblDefaultorganizationbasedsettings,lblChangePassword,lblBrowsefromfolder,lblDraghere,lblor,lblchange,lblCurrentPassword,lblNewPassword,lblcharactersmin,lblConfirmNewPassword,lblPasswordmust,lblWrongPassword,lblCurrentpasswordisrequired,lblNewpasswordisrequired,lblConfirmpasswordisrequired,lblNewPasswordandconfirmpasswordmustmatch,lblBeatleasteightcharacterslong,lblContainatleastoneuppercaseletter,lblContainatleastonelowercaseletter,lblContainatleastonenumber,lblContainatleastonespecialcharacter';
