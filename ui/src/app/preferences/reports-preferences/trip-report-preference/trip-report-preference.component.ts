...
export class TripReportPreferenceComponent implements OnInit {
  ...
  onConfirm(){
    ...
    this.initData.forEach(element => {
      ...
      if(search.length > 0){
        _dataArr.push({ dataAttributeId: element.dataAtrributeId, state: "A", type: "D", chartType: "", thresholdType: "", thresholdValue: "" });
      }else{
        _dataArr.push({ dataAttributeId: element.dataAtrributeId, state: "I", type: "D", chartType: "", thresholdType: "", thresholdValue: "" });
      }
    });
