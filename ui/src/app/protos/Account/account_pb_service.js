...
AccountService.AddAccountToGroups = {
  methodName: "AddAccountToGroups",
  service: AccountService,
  requestStream: false,
  responseStream: false,
  requestType: src_app_protos_Account_account_pb.AccountGroupRefRequest,
  responseType: src_app_protos_Account_account_pb.AccountGroupRefResponce
};
...
AccountServiceClient.prototype.addAccountToGroups = function addAccountToGroups(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(AccountService.AddAccountToGroups, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
