  ...
  ngOnInit(): void {
    ...
    if (this.actionType == 'edit' || this.actionType == 'duplicate') {
      if (
        ...
        (this.selectedRowData.alertUrgencyLevelRefs[0].alertTimingDetail
          .length > 0 ||
          (this.selectedRowData.alertUrgencyLevelRefs[0].alertFilterRefs
            .length > 0 &&
            this.selectedRowData.alertUrgencyLevelRefs[0].alertFilterRefs[0]
              .alertTimingDetail.length > 0))
      ) {
      ...
      if (
        this.selectedRowData.alertUrgencyLevelRefs[0].alertTimingDetail.length >
        0
      ) {
        this.selectedRowData.alertUrgencyLevelRefs[0].alertTimingDetail.forEach(
          (element) => {
        ...
        this.selectedRowData.alertUrgencyLevelRefs[0].alertFilterRefs.length >
          0 &&
        this.selectedRowData.alertUrgencyLevelRefs[0].alertFilterRefs[0]
          .alertTimingDetail.length > 0
      ) {
        this.selectedRowData.alertUrgencyLevelRefs[0].alertFilterRefs[0].alertTimingDetail.forEach(
          (element) => {
            element.dayType.forEach((item, index) => {
              if (item == true) {
                let totalTime = this.convertTimeIntoHours(
