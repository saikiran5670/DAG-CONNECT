...
checkForPreference(fieldKey) {
  if (this.dashboardPrefData.subReportUserPreferences && this.dashboardPrefData.subReportUserPreferences.length > 0 && this.dashboardPrefData.subReportUserPreferences[3].subReportUserPreferences.length != 0) {
...
checkForVehiclePreference(fieldKey) {
  if (this.dashboardPrefData.subReportUserPreferences && this.dashboardPrefData.subReportUserPreferences.length > 0 && this.dashboardPrefData.subReportUserPreferences[2].subReportUserPreferences.length != 0) {
