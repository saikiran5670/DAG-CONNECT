...
compareHere(a, b) {
  ...
  updateBrandIcon(){
    let defaultIcon = "./assets/Daf-Connect-Logo.png";
    ...
    this.uploadLogo = this.organisationData["icon"] && this.organisationData["icon"] != "" ? this.domSanitizer.bypassSecurityTrustUrl('data:image/jpg;base64,' + this.organisationData["icon"]) : this.domSanitizer.bypassSecurityTrustUrl(defaultIcon);
