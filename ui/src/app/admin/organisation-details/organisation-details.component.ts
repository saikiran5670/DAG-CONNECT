...
export class OrganisationDetailsComponent implements OnInit {
  ...
  updateBrandIcon(){
    ...
    this.uploadLogo = this.organisationData["iconByte"] && this.organisationData["iconByte"] != "" ? this.domSanitizer.bypassSecurityTrustUrl('data:image/jpg;base64,' + this.organisationData["iconByte"]) : this.domSanitizer.bypassSecurityTrustUrl('data:image/jpg;base64,' + defaultIcon);
    if(!this.organisationData["iconByte"] || this.organisationData["iconByte"] == ""){
