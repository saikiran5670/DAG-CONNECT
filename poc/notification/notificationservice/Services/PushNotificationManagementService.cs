...
using pushnotificationcorecomponent;
...
namespace notificationservice.Services
{
    ...
    public class PushNotificationManagementService : PushNotificationService.PushNotificationServiceBase
    {
        ...
        private void test()
        {
            Worker.Consumer(_kafkaConfiguration.EH_FQDN, _kafkaConfiguration.EH_CONNECTION_STRING, _kafkaConfiguration.CONSUMER_GROUP, _kafkaConfiguration.EH_NAME, _kafkaConfiguration.CA_CERT_LOCATION);
        }
    }
}
