...
-- INSERT INTO master.idlingconsumption  (min_val , max_val  , description)  SELECT 0.0,0.002,'Very Good' WHERE NOT EXISTS  (   SELECT 1   FROM master.idlingconsumption  WHERE description = 'Very Good' );
-- INSERT INTO master.idlingconsumption  (min_val , max_val  , description)  SELECT 0.002 ,0.020 ,'Good' WHERE NOT EXISTS  (   SELECT 1   FROM master.idlingconsumption  WHERE description = 'Good' );
-- INSERT INTO master.idlingconsumption  (min_val , max_val  , description)  SELECT 0.020 ,null,'Very Good' WHERE NOT EXISTS  (   SELECT 1   FROM master.idlingconsumption  WHERE description = 'Moderate' );
...
-- INSERT INTO master.averagetrafficclassification  (min_val , max_val  , description)  SELECT 0.0 ,0.3,'Light' WHERE NOT EXISTS  (   SELECT 1   FROM master.averagetrafficclassification  WHERE description = 'Light' );
-- INSERT INTO master.averagetrafficclassification  (min_val , max_val  , description)  SELECT 0.3 ,1.3,'Medium' WHERE NOT EXISTS  (   SELECT 1   FROM master.averagetrafficclassification  WHERE description = 'Medium' );
-- INSERT INTO master.averagetrafficclassification  (min_val , max_val  , description)  SELECT 1.3 ,null,'High ' WHERE NOT EXISTS  (   SELECT 1   FROM master.averagetrafficclassification  WHERE description = 'Hight' );
